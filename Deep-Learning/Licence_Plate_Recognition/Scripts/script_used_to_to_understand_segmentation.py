...
def segment_characters(image,j,k) :
    ...
    cv2.imwrite('./first_step/plate{}/{}.jpg'.format(j,k),image)
    k+=1
    #inc(cc,k)
    
    cv2.imwrite('./first_step/plate{}/{}.jpg'.format(j,k),img_lp)
    k+=1
    #inc(cc,k)
    
    plt.imshow(img_gray_lp, cmap='gray')
    #plt.show()
    cv2.imwrite('./first_step/plate{}/{}.jpg'.format(j,k),img_gray_lp)
    k+=1
    #inc(cc,k)
    ...
    #plt.show()
    cv2.imwrite('./first_step/plate{}/{}.jpg'.format(j,k),img_binary_lp)
    k+=1
    #inc(cc,k)
...
def final_img(char,j,k):
    ...
    for i,ch in enumerate(char):
        ...
        #plt.axis('off')
        plt.savefig('./first_step/plate{}/prediction_result{}.jpg'.format(j,j))
        k+=1
        #inc(cc,k)
    #plt.show()
